...
<section class="py-5">
    <div class="container">
        <div class="card">
            <h2 class="pt-3 pb-3 text-center text-success">EDIT PRODUCT</h2>

            <div class="card-body">
                <form method="POST" action="/admin/product/edit" enctype="multipart/form-data" id="updateForm">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-8 text-secondary">
                            <textarea class="border border-secondary form-control" rows="4" id="description" name="description"><?=$params->description?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-8 text-secondary">
                            <input class="form-control form-control-file" type="file" id="thumbnail" name="thumbnail">
                            <div class="text-danger">
                ...
                <div class="col-sm-12 text-center">
                    <button type="submit" id="btnConfirmUpdate" form="updateForm" class="btn btn-success">Update</button>
